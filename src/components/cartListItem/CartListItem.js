...
class CartListItem extends Component{
    ...
    componentDidUpdate(prevProps){    // 5. А так же обязательно прописывается componentDidUpdate(), чтобы state обновлял value при увеличении и уменьшении количества товара
    ...
    render(){
        const {naming, price, img, quantity, onDelete, onPlus, onMinus, onUpdateQuantity} = this.props;
        ...
        return(
            <li className="cart__item">
                ...
                <div className="cart__item-total">{price * quantity} ₽</div>
